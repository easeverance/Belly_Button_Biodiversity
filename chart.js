...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    var sampleID = sampleArray.filter(data => data.id == sample);
    ...
    var otu_ids = firstSampleID.otu_ids;
    var otu_labels = firstSampleID.otu_labels;
    var sample_values = firstSampleID.sample_values;
    ...
    Plotly.newPlot("bar", trace, barLayout, {responsive: true});
